...
x_train_csv.to_csv('/opt/airflow/data/lab3/x_train.csv', index=False)
y_train_csv = pd.DataFrame(y_train)
y_train_csv.to_csv('/opt/airflow/data/lab3/y_train.csv', index=False)

x_val_csv = pd.DataFrame(x_val)
x_val_csv.to_csv('/opt/airflow/data/lab3/x_val.csv', index=False)
y_val_csv = pd.DataFrame(y_val)
y_val_csv.to_csv('/opt/airflow/data/lab3/y_val.csv', index=False)

x_test_csv = pd.DataFrame(x_test)
x_test_csv.to_csv('/opt/airflow/data/lab3/x_test.csv', index=False)
y_test_csv = pd.DataFrame(y_test)
y_test_csv.to_csv('/opt/airflow/data/lab3/y_test.csv', index=False)