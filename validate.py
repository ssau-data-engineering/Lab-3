...
x_test = np.asarray(pd.read_csv(f"/opt/airflow/data/x_test.csv"), dtype=np.float32)
y_test = pd.read_csv(f"/opt/airflow/data/y_test.csv")

sk_models = {}
mlflow.start_run(run_name = "Production model")
